...
public class RenderFlareRocket extends Render {
    private static final ResourceLocation flareTextures = new ResourceLocation(RandomTech.modid.toLowerCase() + ":textures/entity/flareRocket.png");

    public void doRender(EntityFlareRocket bolt, double x, double y, double z, float unknown_1, float unknown_2) {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityFlareRocket bolt) {
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        return this.getEntityTexture((EntityFlareRocket) entity);
    }
    ...
    public void doRender(Entity entity, double x, double y, double z, float unknown_1, float unknown_2) {
        this.doRender((EntityFlareRocket) entity, x, y, z, unknown_1, unknown_2);
    }
}