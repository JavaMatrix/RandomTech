...
public class ItemHardenedMagicalAxe extends ItemAxe implements IHardenedItem {
    public ItemHardenedMagicalAxe() {
        super(EnumHelper.addToolMaterial("hardenedMagicalAxe", 3, 100, 9.0f, 2.5f,
                                         22));
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List lore,
                               boolean par4) {
        lore.add("\u00a76Perun would be proud.");
    }
