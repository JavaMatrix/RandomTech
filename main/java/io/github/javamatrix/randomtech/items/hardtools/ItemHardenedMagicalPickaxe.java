...
public class ItemHardenedMagicalPickaxe extends ItemPickaxe implements IHardenedItem {

    public ItemHardenedMagicalPickaxe() {
        super(EnumHelper.addToolMaterial("hardenedMagicalPick", 3, 100, 9.0f, 2.5f,
                                         22));
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List lore,
                               boolean par4) {
        lore.add("\u00a76Straight from Nidavellir!");
    }
