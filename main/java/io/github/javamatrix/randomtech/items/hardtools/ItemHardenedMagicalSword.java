...
public class ItemHardenedMagicalSword extends ItemSword implements IHardenedItem {

    public ItemHardenedMagicalSword() {
        super(EnumHelper.addToolMaterial("hardenedMagicalSword", 3, 100, 9.0f, 2.5f,
                                         22));
    }
