...
public class ItemHardenedMetalShovel extends ItemSpade implements IHardenedItem {

    public ItemHardenedMetalShovel() {
        super(EnumHelper.addToolMaterial("hardenedMetalShovel", 3, 100, 7.0f, 2.5f,
                                         10));
    }
