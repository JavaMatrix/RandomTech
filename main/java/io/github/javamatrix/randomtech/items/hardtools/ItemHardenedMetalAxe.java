...
public class ItemHardenedMetalAxe extends ItemAxe implements IHardenedItem {
    public ItemHardenedMetalAxe() {
        super(EnumHelper.addToolMaterial("hardenedMetalAxe", 3, 100, 12.0f, 2.5f,
                                         10));
    }
