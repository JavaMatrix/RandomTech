...
// Code by Slime Knights, edited by JavaMatrix to remove some unused variables.
...
public class FancyItemRender extends Render {
    ...
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5, boolean renderEffect) {
        ...
        if (par3ItemStack.getItemSpriteNumber() == 0 && block != null && RenderBlocks.renderItemIn3d(block.getRenderType())) {
            ...
            for (int j1 = 0; j1 < k.getRenderPasses(l); ++j1) {
                ...
                this.renderIcon(par4, par5, icon);
            ...
            this.renderIcon(par4, par5, (IIcon) object);
            GL11.glEnable(GL11.GL_LIGHTING);
    ...
    private void renderGlint(int x, int y) {
        for (int j1 = 0; j1 < 2; ++j1) {
            ...
            tessellator.addVertexWithUV((double) (x + 0), (double) (y + 16), (double) this.zLevel, (double) ((f2 + (float) 16 * f4) * f), (double) ((f3 + (float) 16) * f1));
            tessellator.addVertexWithUV((double) (x + 20), (double) (y + 16), (double) this.zLevel, (double) ((f2 + (float) 20 + (float) 16 * f4) * f), (double) ((f3 + (float) 16) * f1));
            tessellator.addVertexWithUV((double) (x + 20), (double) (y + 0), (double) this.zLevel, (double) ((f2 + (float) 20) * f), (double) ((f3 + 0.0F) * f1));
    ...
    public void renderIcon(int par1, int par2, IIcon par3Icon) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV((double) (par1 + 0), (double) (par2 + 16), (double) this.zLevel, (double) par3Icon.getMinU(), (double) par3Icon.getMaxV());
        tessellator.addVertexWithUV((double) (par1 + 16), (double) (par2 + 16), (double) this.zLevel, (double) par3Icon.getMaxU(), (double) par3Icon.getMaxV());
        tessellator.addVertexWithUV((double) (par1 + 16), (double) (par2 + 0), (double) this.zLevel, (double) par3Icon.getMaxU(), (double) par3Icon.getMinV());
